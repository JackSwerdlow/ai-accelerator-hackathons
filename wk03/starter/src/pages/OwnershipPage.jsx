...
import { totalSteps, ownershipNext } from "../flow";
...
/**
 * Renders the "What is your ownership status?" question (step 2), with a hint
 * clarifying that mortgaged owners pick "I own my home". This is the tenure
 * branch point: owners continue to income, tenants to landlord consent
 * (content plan §11).
 *
 * @returns {JSX.Element}
 */
export default function OwnershipPage() {
  return (
    <QuestionPage
      ...
      onContinueNavigateTo={ownershipNext}
    />
  );
}
