...
**Author:** Agent-Tom  
**Date:** 2026-06-24  
**Status:** Active plan — companion to `docs/specs/mvp-agent-tom.md`  
**Note:** Pydantic models and configuration values are now authoritative in `mvp-agent-tom.md §§3,8`.
...
alongside `mvp-agent-tom.md`, not instead of it.  
